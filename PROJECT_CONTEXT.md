...
- M1-007 graph canvas UI tamamlandı.
- M1-008 resource bar and inspector tamamlandı.
- M1-009 save/load v0 tamamlandı.
- M1-010 smoke tests and decision log tamamlandı.
- M1 `d976f37c4e1defa1a8142e83ad8fbd0c54a76ab3` commit'iyle `origin/main` üzerinde frozen baseline olarak kabul edildi.
- M2-001 Power and Heat System tamamlandı: power capacity/usage, heat generation/pressure, `power_limited` ve `heat_throttled` reason'ları, Resource Bar Power/Heat göstergeleri ve Inspector power/heat katkısı eklendi.
- M2-002 Contract System v0 tamamlandı: basit contract definitions, available/active/completed/claimed state, deterministic progress, once-only reward claim, minimal Contract panel, save/load persistence ve test coverage eklendi.
...
- Sıradaki hedef: M2-004 Buy Max and upgrade scaling.
