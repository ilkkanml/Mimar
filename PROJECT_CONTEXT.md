...
- M1 artık freeze candidate durumunda: final automated checks ve browser smoke geçti, `docs/M1_COMPLETION_REPORT.md` kapanış raporu olarak eklendi.
- Sıradaki hedef: M1 freeze kabulünden sonra M2 planlama veya M2-001.
